//
//  TextMessageCollectionViewCellLetsSeeStyle.swift
//  Flint
//
...
open class TextMessageCollectionViewCellLetsSeeStyle: TextMessageCollectionViewCellStyleProtocol {
    typealias Class = TextMessageCollectionViewCellLetsSeeStyle
    ...
    private enum ImageKey: Hashable {
        ...
        static func == (lhs: TextMessageCollectionViewCellLetsSeeStyle.ImageKey, rhs: TextMessageCollectionViewCellLetsSeeStyle.ImageKey) -> Bool {
            switch (lhs, rhs) {
...
public extension TextMessageCollectionViewCellLetsSeeStyle { // Default values
